...
echo "========================================================================"
echo ""
echo "  Next steps (see docs/setup/README.md):"
echo "  1. Verify cluster:          kubectl get nodes"
echo "  2. Provision substrate:     make infra-apply  (namespaces + ArgoCD)"
echo "  3. Deploy security & Vault: (docs/setup/README.md Step 4)"
echo "  4. Seed runtime secrets:    make seed-secrets"
echo "  5. Apply ArgoCD root apps:  kubectl apply -f argocd/dev/root.yaml"
echo "  6. Verify platform health:  make verify"
echo ""
