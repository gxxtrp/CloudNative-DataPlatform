#!/usr/bin/env bash
# ==============================================================================
# ARCHIVED: 3-Node k3s Host Bootstrap Script
# This script is SUPERSEDED by host-bootstrap-single.sh.
#
# The 3-node simulation requires ~3.8 GB RAM baseline (3x kubelet+flannel+DNS).
# It is NOT EKS-compatible (uses Linux netns instead of separate EC2 nodes).
# Kept for reference and historical documentation only.
#
# Use: host-bootstrap-single.sh (single-node, ~2.7 GB baseline)
# ==============================================================================
